...
const RuDeLabsLogin = (props) => {
  ...
  const  onSubmit = (data) => {
    ...
    props.history.push('RuDeLabsInvoiceList') 
        ...
        <div className="loginbox">
          <div className="login-right">
            <div className="login-right-wrap">
              <h1>Login</h1>
              <p className="account-subtitle">Access to RuDeLabs Assignment</p>
              <div>
